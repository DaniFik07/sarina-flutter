...
class _CovidPageState extends State<CovidPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: list_all_prov.length > 0? ListView.builder(
...
setState(() {
  ...
  print("jaaamsss "+ val.tanpaProvinsi.toString());
  print("jaaamsss4 ${val.tanpaProvinsi.toString()}");
  print("jaaamsss5 ");

  print("jaaamsss2 "+ list_all_prov.length.toString());
  print("jaaamsss3 "+ val.lastDate.toString());
